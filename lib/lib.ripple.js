    ...
    GTG_style.innerHTML = `
      ...
      .ripple {
        ...
        transform: scale(0);
        pointer-events: none;
        transition: transform 1.3s ease-out, opacity 0.8s ease-out;
      }
    `;
    ...
    function GTG_createRipple(event) {
      ...
      GTG_ripple.style.boxShadow = `0 0 30px 5px ${GTG_rippleColor}`;
    ...
    GTG_applyRippleEffect('button', 'rgba(255, 255, 255, 0.5)');
